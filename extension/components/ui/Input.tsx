...
const Input: ForwardRefExoticComponent<InputSetting & RefAttributes<HTMLInputElement>> = forwardRef<
	HTMLInputElement,
	InputSetting
	...
	const handleChange = useCallback(
		(e: ChangeEvent<HTMLInputElement>) => {
			if (isFileInput) {
				...
				const limitedValue = Math.min(Math.max(value, minValue), maxValue).toString();
		...
		[debouncedStringOnChange, settings, isFileInput, isNumberInput, onChange],
	);
