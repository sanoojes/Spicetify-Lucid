        ...
        components: [
          {
            ...
            initialColor:
              DEFAULT_STATE.player[
                mode === "compact" ? "compactStyle" : "defaultStyle"
              ].bgColor,
          ...
          },
          {
            ...
            validation: (v) =>
              PlayerStyleSchema.shape.borderRadius.safeParse(v),
            onChange: (borderRadius) =>
              state.setPlayerStyles(mode, { borderRadius }),
          },
          {
            ...
            validation: (v) =>
              PlayerStyleSchema.shape.coverArtRadius.safeParse(v),
            onChange: (coverArtRadius) =>
              state.setPlayerStyles(mode, { coverArtRadius }),
          },
        ],
      },
      {
        ...
        components: [
          ...
          },
          {
            ...
            onChange: (brightness) =>
              state.setPlayerBackdropFilter(mode, { brightness }),
          },
          {
            id: `contrast-${mode}`,
            type: "Input",
            ...
            onChange: (contrast) =>
              state.setPlayerBackdropFilter(mode, { contrast }),
          },
          {
            id: `saturation-${mode}`,
            type: "Input",
            ...
            onChange: (saturation) =>
              state.setPlayerBackdropFilter(mode, { saturation }),
          },
          {
            id: `opacity-${mode}`,
            type: "Input",
            ...
            onChange: (opacity) =>
              state.setPlayerBackdropFilter(mode, { opacity }),
          },
        ],
      },
