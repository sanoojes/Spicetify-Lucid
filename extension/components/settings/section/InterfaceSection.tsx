	...
	const INTERFACE_SETTINGS_CARDS: SettingCardMap = [
			...
			cardProps: {
				...
				tooltip: (
					<>
						...
						<span>Choose 'Compact' for a minimized view or 'Normal' for a detailed layout</span>
					</>
				),
				type: "dropdown",
				settings: {
		...
		},
		{
			...
			cardProps: {
				...
				tooltip: (
					<>
						<h3 className="encore-text encore-text-medium-bold">Select where the right sidebar appears.</h3>
					</>
				),
				type: "dropdown",
				settings: {
