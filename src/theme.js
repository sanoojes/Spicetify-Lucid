...
`,document.head.appendChild(g)}X(),J(),h&&v(f,w),Spicetify.Player.addEventListener("songchange",()=>{!async function(){document.documentElement.style.setProperty("--fade-time","1s")}(),X(),h&&v(f,w)}),window.addEventListener("resize",J),_(),console.log("Lucid theme loaded."),(async()=>{var e;await y("#customControls",5e3)&&(window.isCustomControls=!0,null!=(e=document.querySelector(".lucid-transperent-window-controls")))&&e.remove()})()};(async()=>{await Y()})()})()}();