  ...
  (() => {
    var o = Object.defineProperty,
      ...
      s = (t, e, a) =>
        e in t
          ...
          : (t[e] = a),
      c = (t, e) => {
        for (var a in (e = e || {})) l.call(e, a) && s(t, a, e[a]);
        if (i) for (var a of i(e)) r.call(e, a) && s(t, a, e[a]);
        return t;
      },
      d = (t, e) => a(t, n(e)),
      m = [
      ...
      h = !1;
    async function f(t, e = 50, a = 100) {
      let o = 0;
      for (; o < e; ) {
        var n = document.querySelector(t);
        if (n) return n;
        await new Promise((t) => setTimeout(t, a)), o++;
      }
      throw new Error(`Element ${t} not found after ${e} attempts.`);
    }
    var e = "",
    ...
    function k() {
      e = (e =
        ...
        Spicetify.Player.data.item.metadata.image_url).replace(
        "spotify:image:",
        "https://i.scdn.co/image/"
      );
      try {
        (u.innerText = ""), (u.innerText = `:root { --image-url: url(${e}); }`);
      } catch (t) {
        console.error("Error updating album art:", t);
      }
    }
    ...
    async function x() {
      ...
      try {
        var i,
          ...
          s = await f("section");
        let t = "relative";
        ((null != (e = s.dataset.testid) && e.includes("album")) ||
          (null != (a = s.dataset.testid) && a.includes("playlist")) ||
          (null != (o = s.dataset.testid) && o.includes("artist"))) &&
          (t = "absolute"),
          s &&
            null != (n = s.dataset) &&
            n.testUri &&
            ((l = (i = s.dataset.testUri.toLowerCase()).includes("artist")),
            (r = i.includes("album-page")),
            (t =
              l ||
              0 !==
              ...
              r
                ? "absolute"
                : "relative")),
          (p.innerText = `:root { --header-position: ${t}; }`);
      } catch (t) {
        console.error("[Lucid] Error waiting for section element:", t);
      }
    }
    async function b(t) {
      let a = await f(".Root__top-container").catch((t) => console.error(t));
      function e() {
        var t =
            null == a
              ? void 0
              : a.querySelector(".bloom-animated-background-container"),
          e =
            null == a
              ? void 0
              : a.querySelector(".bloom-static-background-container");
      ...
      try {
        if ("animated" === t) {
          var o,
            n = function () {
              var t = Math.floor(360 * Math.random());
            ...
            l =
              (i.classList.add("bloom-animated-background-container"),
              ["front", "back", "backleft", "backright"]);
          for (o of l) {
            var r = document.createElement("div");
            r.classList.add(o), i.appendChild(r);
          }
          null != a && a.prepend(i);
        }
        var s;
    ...
    document.head.appendChild(p), document.head.appendChild(p);
    ...
    async function S() {
      ...
      h ||
        ...
        (a = window.innerWidth),
        (e = 0 < (a = (window.outerWidth / a) * 100) ? a / 50 : 0),
        t ||
          (console.log(`Current zoom level: ${a}%`),
          (t = Math.round(a ** 0.912872807 * 100) / 100 - 2),
          (a = 4 * 1 ** e),
          (e = 9 + 1 ** e),
        ...
        `)),
        "windows" === Spicetify.Platform.PlatformData.os_name &&
          "light" !== Spicetify.Config.color_scheme &&
          (B.classList.add("bloom-transperent-window-controls"),
          B.style.setProperty("--control-height", "64px"),
          B.style.setProperty("--control-width", "135px")));
    }
    ...
    function C() {
      ...
      if (e)
        try {
          let t = JSON.parse(e);
          return m.map((e) => {
            let a = t.find((t) => t.section === e.section);
            return d(c({}, e), {
              items: e.items.map((e) => {
                var t = a ? a.items.find((t) => t.key === e.key) : void 0;
                return d(c({}, e), { value: t ? t.value : e.default });
              }),
            });
          });
        } catch (t) {
    ...
    v.className = "bloom-settings-container";
    {
      C().forEach((t) => {
        let o = document.createElement("div");
        o.className = "bloom-settings-card";
        ...
        e.classList.add(
          ...
          (e.textContent = t.section),
          o.appendChild(e),
          t.items.forEach((i) => {
            var t = document.createElement("div"),
              e =
                ((t.className = "bloom-settings-input-card"),
              ...
              a =
                ...
                (e.innerText = i.label),
                (e.htmlFor = i.key + "-input"),
                document.createElement("p"));
            a.classList.add(
              "encore-text-body-small",
              "encore-internal-color-text-subdued"
            ),
              (a.innerText = i.tooltip || "");
            let l = document.createElement("input"),
              r =
                ((l.className = "Lucid-slider"),
                (l.type = "range"),
                (l.id = i.key + "-input"),
                (l.min = String(i.min)),
                (l.max = String(i.max)),
                (l.value = String(void 0 !== i.value ? i.value : i.default)),
                document.createElement("span"));
            (r.id = i.key + "-value"),
              (r.textContent = "" + l.value + i.unit),
              (r.className = "Lucid-slider-value"),
              $(i.key, "" + l.value + i.unit),
              l.addEventListener("input", () => {
                var t,
                  e = parseInt(l.value, 10),
                  a =
                    ((r.textContent = "" + e + i.unit),
                    $(i.key, "" + e + i.unit),
                    i.key),
                  o = C(),
                  n = o.findIndex((t) => t.items.some((t) => t.key === a));
                -1 !== n &&
                  -1 !== (t = o[n].items.findIndex((t) => t.key === a)) &&
                  ((o[n].items[t].value = e),
            ...
            (e.className = "Lucid-slider-container"),
              e.appendChild(l),
              e.appendChild(r),
              t.appendChild(e),
              o.appendChild(t);
      ...
      var E = document.createElement("div"),
        P =
          (E.classList.add("bloom-settings-section"),
          document.createElement("h2")),
        _ =
          (P.classList.add("bloom-settings-subtitle"),
          (P.textContent = "Background Options"),
          document.createElement("div")),
        L =
          (_.classList.add("bloom-dropdown-container"),
          document.createElement("h2"));
      L.classList.add("bloom-slider-label"),
        (L.textContent = "Background"),
        _.appendChild(L);
      let a = document.createElement("select");
      a.classList.add("bloom-dropdown", "main-dropDown-dropDown"),
        [
          ...
          (e.textContent = t.text), (e.value = t.value), a.appendChild(e);
        }),
        (L = localStorage.getItem("selectedBackground") || "static"),
        b((a.value = L)),
        a.addEventListener("change", function () {
          try {
            var t = this.value;
            console.log("[Lucid] Selected Background:", t),
              localStorage.setItem("selectedBackground", t),
              b(t);
          } catch (t) {
            console.log("[Lucid] Error setting Stored Background: ", t);
          }
        }),
        E.appendChild(P),
        E.appendChild(_),
        _.appendChild(a),
        v.appendChild(E),
        ((L = document.createElement("button")).className = "bloom-reset-btn"),
        (L.textContent = "Reset to Defaults"),
        L.addEventListener("click", () => {
          confirm(
            "Are you sure you want to reset all settings to their default values?"
          ) &&
            (localStorage.removeItem("settings"),
            document.querySelectorAll(".Lucid-slider").forEach((t) => {
              var e = t.id.replace("-input", ""),
                a = (function (e) {
                  for (var t of m) {
                    t = t.items.find((t) => t.key === e);
                    if (t) return t;
                  }
                })(e);
              a &&
                ((t.value = String(a.default)),
    ...
    var j = async function () {
      ...
      "windows" ===
        ...
        "light" !== Spicetify.Config.color_scheme &&
        null != (a = document.querySelector(".Root__main-view")) &&
        a.prepend(B);
      var a = Spicetify["Locale"];
      function o(t) {
        return t.replace(/[{0}{1}«»”“]/g, "").trim();
      }
      if (a) {
        var n = o(a.get("playlist.a11y.play")),
          i = o(a.get("playlist.a11y.pause")),
          l = a.get("${playLabel}"),
          r = a.get("${pauseLabel}"),
          s = a.get("browse"),
          c = a.get("web-player.aligned-curation.tooltips.add-to-liked-songs"),
          d = a.get("web-player.aligned-curation.tooltips.add-to-playlist"),
          m = a.get("playback-control.skip-forward"),
          u = a.get("playback-control.skip-back"),
          p = a.get("web-player.whats-new-feed.button-label"),
          b = a.get("buddy-feed.friend-activity"),
          g = a.get("tracklist.a11y.play"),
          y = a.get("view.web-player-home");
        let t, e;
...
.main-repeatButton-button[aria-label="${a.get(
...
#context-menu ul[aria-label*="${a.get(
...
`),
      ...
      document.head.appendChild(t),
        ...
        Spicetify.Player.addEventListener("songchange", () => {
          !(async function () {
            document.documentElement.style.setProperty("--fade-time", "1s");
          })(),
            k();
        }),
      ...
      null != v &&
        v.addEventListener("scroll", () => {
          var t, e;
          0 === v.scrollTop && x(),
            document.querySelector(".under-main-view div") &&
              v.scrollTop !== window.innerHeight &&
              ((t = (t = v).scrollTop),
              (e = window.innerHeight),
              (e = Math.min(t, e)),
              (w.innerText = `:root {--scroll-top: ${e}px;}`),
              0);
        }),
        ...
        setTimeout(() => {
          (async () => {
            var t;
            (await f("#customControls")) &&
              ((h = !0),
              null !=
                (t = document.querySelector(
                  ".bloom-transperent-window-controls"
                ))) &&
              t.remove();
          })();
        }, 300);
