...
var Lucid = (() => {
  ...
  var ICON_CSS_CACHE_KEY = "LUCID_CSS_SCRIPT_CACHE";
  var ICON_CSS_STYLE_ID = "lucid-icons";
...
`;
  ...
  var patchIcons = () => {
    try {
      let cleanLabel2 = function(label) {
        const cleanedLabel = label.replace(/[{0}{1}«»”“]/g, "").trim();
        return cleanedLabel;
      };
      var cleanLabel = cleanLabel2;
      mountIconVariables();
      const g = (value, clean = false) => clean ? cleanLabel2(LocaleAPI.get(value)) : LocaleAPI.get(value);
 ...
 `;
    ...
    render() {
      ...
      switch (this._inputOptions.type) {
        ...
        case "image": {
          ...
          this._previewElement.src = (_a2 = this._inputOptions.value) != null ? _a2 : "";
          this.prepend(this._previewElement);
          this._inputElement.onchange = (e) => {
            var _a3;
            const target = e.target;
            const file = (_a3 = target.files) == null ? void 0 : _a3[0];
            if (file) {
              const reader = new FileReader();
              reader.onload = (event) => {
                var _a4;
                const dataUrl = (_a4 = event.target) == null ? void 0 : _a4.result;
          ...
          this.append(
            new Button({
              ...
              onChange: () => {
                var _a3;
                (_a3 = this._inputElement) == null ? void 0 : _a3.click();
              }
            }),
            this._inputElement
          );
  ...
  async function mountAndOpenGuide(open = false) {
    ...
    if (!localStorage.getItem(GUIDE_STORAGE_KEY) || open) {
      await mountGuide();
      if ((_a2 = window == null ? void 0 : window.guide) == null ? void 0 : _a2.open) {
        window.guide.open();
  ...
  async function getSettings(state = setting_default.getState(), settings = setting_default) {
    var _a2, _b, _c, _d, _e, _f;
