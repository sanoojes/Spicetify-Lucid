...
`),"none"===t&&(b.innerText=`
  :root {
    ...
    `)}catch(t){console.error(t)}}document.head.appendChild(b);var f,B,E=document.createElement("div");function $(t,e){document.body.style.setProperty("--"+t,e)}function P(){var e=localStorage.getItem("settings");if(e)try{let t=JSON.parse(e);return u.map(e=>{let a=t.find(t=>t.section===e.section);return d(c({},e),{items:e.items.map(e=>{var t=a?a.items.find(t=>t.key===e.key):void 0;return d(c({},e),{value:t?t.value:e.default})})})})}catch(t){console.error("Error loading settings:",t)}return JSON.parse(JSON.stringify(u))}E.className="lucid-settings-container";{for(f of P()){var I=document.createElement("div"),_=(I.className="lucid-settings-card",document.createElement("h2"));_.classList.add("settings-section-heading","encore-text-title-small","encore-internal-color-text-base"),_.textContent=f.section,I.appendChild(_);for(let r of f.items){var j=document.createElement("div"),N=(j.className="lucid-settings-input-card",document.createElement("label")),T=(N.classList.add("settings-section-label","encore-text-title-small","encore-internal-color-text-subdued"),N.innerText=r.label,N.htmlFor=r.key+"-input",document.createElement("p"));T.classList.add("encore-text-body-small","encore-internal-color-text-subdued"),T.innerText=r.tooltip||"";let o=document.createElement("input"),l=(o.className="Lucid-slider",o.type="range",o.id=r.key+"-input",o.min=String(r.min),o.max=String(r.max),o.value=String(void 0!==r.value?r.value:r.default),document.createElement("span"));l.id=r.key+"-value",l.textContent=""+o.value+r.unit,l.className="Lucid-slider-value",$(r.key,""+o.value+r.unit),o.addEventListener("input",()=>{var t,e=Number.parseInt(o.value,10),a=(l.textContent=""+e+r.unit,$(r.key,""+e+r.unit),r.key),i=P(),n=i.findIndex(t=>t.items.some(t=>t.key===a));-1!==n&&-1!==(t=i[n].items.findIndex(t=>t.key===a))&&(i[n].items[t].value=e,localStorage.setItem("settings",JSON.stringify(i)))}),j.appendChild(N),j.appendChild(T);N=document.createElement("div");N.className="Lucid-slider-container",N.appendChild(o),N.appendChild(l),j.appendChild(N),I.appendChild(j)}E.appendChild(I)}let e=async(t,e,a,i)=>{var n,o=document.createElement("div"),l=(o.classList.add("lucid-dropdown-container"),document.createElement("h2"));l.classList.add("lucid-slider-label"),l.textContent=a,o.appendChild(l);let r=document.createElement("select");r.classList.add("lucid-dropdown","main-dropDown-dropDown");for(n of t){var s=document.createElement("option");s.textContent=n.text,s.value=n.value,r.appendChild(s)}a=localStorage.getItem(e)||t[0].value;return r.value=a,i(a),r.addEventListener("change",()=>{var t=r.value;localStorage.setItem(e,t),i(t)}),o.appendChild(r),o},a=document.createElement("div"),i=(a.classList.add("lucid-settings-section"),[{text:"Default Background",value:"static"},{text:"Animated Background",value:"animated"},{text:"Solid Background",value:"solid"}]),n=[{text:"Stary Grains (default)",value:"stary"},{text:"Normal Grains",value:"normal"},{text:"No Grains",value:"none"}];(async()=>{var t=await e(i,"selectedBackground","Background",t=>{y(t)}),t=(a.appendChild(t),await e(n,"lucid-selectedGrains","Background Grains",t=>{v(t)}));a.appendChild(t)})(),E.appendChild(a);var M=document.createElement("button");M.className="lucid-reset-btn",M.textContent="Reset to Defaults",M.addEventListener("click",()=>{if(confirm("Are you sure you want to reset all settings to their default values?")){var t;localStorage.removeItem("settings"),localStorage.removeItem("selectedBackground"),y(),localStorage.removeItem("lucid-selectedGrains"),v();for(t of Array.from(document.querySelectorAll(".Lucid-slider"))){var e=t.id.replace("-input",""),a=function(e){for(var t of u){t=t.items.find(t=>t.key===e);if(t)return t}}(e);a&&(t.value=String(a.default),t=document.getElementById(e+"-value"))&&(e=""+a.default+a.unit,t.textContent=e,$(a.key,e))}}}),E.appendChild(M)}B=E,new Spicetify.Menu.Item("Lucid Settings",!1,()=>{Spicetify.PopupModal.display({title:"Lucid Settings",content:B})},'<svg width="16" height="16" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12.012 2.25c.734.008 1.465.093 2.182.253a.75.75 0 0 1 .582.649l.17 1.527a1.384 1.384 0 0 0 1.927 1.116l1.401-.615a.75.75 0 0 1 .85.174 9.792 9.792 0 0 1 2.204 3.792.75.75 0 0 1-.271.825l-1.242.916a1.381 1.381 0 0 0 0 2.226l1.243.915a.75.75 0 0 1 .272.826 9.797 9.797 0 0 1-2.204 3.792.75.75 0 0 1-.848.175l-1.407-.617a1.38 1.38 0 0 0-1.926 1.114l-.169 1.526a.75.75 0 0 1-.572.647 9.518 9.518 0 0 1-4.406 0 .75.75 0 0 1-.572-.647l-.168-1.524a1.382 1.382 0 0 0-1.926-1.11l-1.406.616a.75.75 0 0 1-.849-.175 9.798 9.798 0 0 1-2.204-3.796.75.75 0 0 1 .272-.826l1.243-.916a1.38 1.38 0 0 0 0-2.226l-1.243-.914a.75.75 0 0 1-.271-.826 9.793 9.793 0 0 1 2.204-3.792.75.75 0 0 1 .85-.174l1.4.615a1.387 1.387 0 0 0 1.93-1.118l.17-1.526a.75.75 0 0 1 .583-.65c.717-.159 1.45-.243 2.201-.252Zm0 1.5a9.135 9.135 0 0 0-1.354.117l-.109.977A2.886 2.886 0 0 1 6.525 7.17l-.898-.394a8.293 8.293 0 0 0-1.348 2.317l.798.587a2.881 2.881 0 0 1 0 4.643l-.799.588c.32.842.776 1.626 1.348 2.322l.905-.397a2.882 2.882 0 0 1 4.017 2.318l.11.984c.889.15 1.798.15 2.687 0l.11-.984a2.881 2.881 0 0 1 4.018-2.322l.905.396a8.296 8.296 0 0 0 1.347-2.318l-.798-.588a2.881 2.881 0 0 1 0-4.643l.796-.587a8.293 8.293 0 0 0-1.348-2.317l-.896.393a2.884 2.884 0 0 1-4.023-2.324l-.11-.976a8.988 8.988 0 0 0-1.333-.117ZM12 8.25a3.75 3.75 0 1 1 0 7.5 3.75 3.75 0 0 1 0-7.5Zm0 1.5a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5Z" fill="#fff"/></svg>').register();var R=async function(){for(;!(null!=Spicetify&&Spicetify.CosmosAsync&&null!=Spicetify&&Spicetify.React&&null!=Spicetify&&Spicetify.Platform&&null!=Spicetify&&Spicetify.Locale&&null!=Spicetify&&Spicetify.Player.data);)await new Promise(t=>setTimeout(t,100));"windows"===(null==Spicetify?void 0:Spicetify.Platform.PlatformData.os_name)&&"light"!==Spicetify.Config.color_scheme&&null!=(a=document.querySelector(".Root__top-container"))&&a.appendChild(L);var a=Spicetify["Locale"];function i(t){return t.replace(/[{0}{1}«»”“]/g,"").trim()}if(a){var n=i(a.get("playlist.a11y.play")),o=i(a.get("playlist.a11y.pause")),l=a.get("${playLabel}"),r=a.get("${pauseLabel}"),s=a.get("browse"),c=a.get("web-player.aligned-curation.tooltips.add-to-liked-songs"),d=a.get("web-player.aligned-curation.tooltips.add-to-playlist"),u=a.get("playback-control.skip-forward"),p=a.get("playback-control.skip-back"),m=a.get("web-player.whats-new-feed.button-label"),g=a.get("buddy-feed.friend-activity"),y=a.get("tracklist.a11y.play"),b=a.get("view.web-player-home");let t,e;["zh-CN","zh-TW","am","fi"].includes(a.getLocale())?[t,e]=y.split("{1}"):[t,e]=y.split("{0}"),t=i(t),e=i(e);y=document.createElement("style");y.innerText=`
...
`,document.head.appendChild(y)}w(),C(),S(),Spicetify.Player.addEventListener("songchange",()=>{!async function(){document.documentElement.style.setProperty("--fade-time","1s")}(),w()}),window.addEventListener("resize",C);let v=await k(".Root__main-view .os-viewport, .Root__main-view .main-view-container > .main-view-container__scroll-node:not([data-overlayscrollbars-initialize]), .Root__main-view .main-view-container__scroll-node > [data-overlayscrollbars-viewport]"),f=!1;null!=v&&v.addEventListener("scroll",()=>{f||(f=!0,requestAnimationFrame(()=>{var t,e;0===v.scrollTop&&S(),document.querySelector(".under-main-view div")&&v.scrollTop!==window.innerHeight&&(t=(t=v).scrollTop,e=window.innerHeight,e=Math.min(t,e),x.innerText=`:root {--scroll-top: ${e}px;}`,0),f=!1}))}),console.log("Lucid theme loaded."),setTimeout(()=>{(async()=>{var t;await k("#customControls")&&(h=!0,null!=(t=document.querySelector(".lucid-transperent-window-controls")))&&t.remove()})()},100)};(async()=>{await R()})()})()}();