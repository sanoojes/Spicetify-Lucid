...
`,document.head.appendChild(g)}document.head.appendChild(t),k(),S(),x(),Spicetify.Player.addEventListener("songchange",()=>{!async function(){document.documentElement.style.setProperty("--fade-time","0.4s")}(),k()}),window.addEventListener("resize",S);let v=await f(".Root__main-view .os-viewport, .Root__main-view .main-view-container > .main-view-container__scroll-node:not([data-overlayscrollbars-initialize]), .Root__main-view .main-view-container__scroll-node > [data-overlayscrollbars-viewport]");null!=v&&v.addEventListener("scroll",()=>{var t,e;0===v.scrollTop&&x(),document.querySelector(".under-main-view div")&&v.scrollTop!==window.innerHeight&&(t=(t=v).scrollTop,e=window.innerHeight,e=Math.min(t,e),w.innerText=`:root {--scroll-top: ${e}px;}`,0)}),console.log("Better Bloom theme loaded."),setTimeout(()=>{(async()=>{var t;await f("#customControls")&&(h=!0,null!=(t=document.querySelector(".bloom-transperent-window-controls")))&&t.remove()})()},300)};(async()=>{await j()})()})()}();