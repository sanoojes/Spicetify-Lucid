...
`;
 ...
 `;
  ...
  function mountSettings() {
    ...
    (_a2 = document.getElementById("main")) == null ? void 0 : _a2.append(settingModal);
...
@keyframes animBg {
  ...
  var setGlobals_default = () => {
    ...
    window.lucid = {
      ...
      version: (_a2 = localStorage.getItem(LUCID_VERSION_STORAGE_KEY)) != null ? _a2 : "2.1.1",
