...
`,document.head.appendChild(b)}W(),J(),x(),f&&v(w,k),Spicetify.Player.addEventListener("songchange",()=>{!async function(){document.documentElement.style.setProperty("--fade-time","1s")}(),W(),f&&v(w,k)}),window.addEventListener("resize",J),N(),console.log("Lucid theme loaded."),(async()=>{var e;await h("#customControls",5e3)&&(window.isCustomControls=!0,null!=(e=document.querySelector(".lucid-transperent-window-controls")))&&e.remove()})()};(async()=>{await Q()})()})()}();