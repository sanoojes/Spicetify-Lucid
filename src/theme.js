...
var Lucid = (() => {
  ...
  var AppSettingsStore = class extends store_default {
    constructor(initialState = defaultAppSettings, options = {
      persist: true,
...
.player-controls__buttons button[data-testid=control-button-playpause] span { background: none !important; }`;
  ...
  async function fetchAndCache(urls, localKey) {
    const oneDay = 864e5;
  ...
  // extension/components/settings/modal.ts
  ...
  var TOUR_STORAGE_KEY = "lucid-guided-tour";

  // extension/hooks/guide.ts
  var GUIDE_SCRIPT_CACHE_KEY = "GUIDE_SCRIPT_CACHE";
  var GUIDE_SCRIPT_LINKS = [
            ...
            fields: [
              ...
              },
              {
                ...
                inputOptions: {
                  ...
                  onClick: () => {
                    localStorage.removeItem("lucid-guided-tour");
                    closeSettings == null ? void 0 : closeSettings();
      ...
      switch (mode) {
        case "static": {
          ...
          if (this.backgroundElement instanceof static_default) {
            ...
            staticElement.customFilter = ((_a2 = this.options) == null ? void 0 : _a2.static.filter) || {};
          } else {
            staticElement = new static_default();
            staticElement.setImageSource(imageUrl);
            staticElement.customFilter = ((_b = this.options) == null ? void 0 : _b.static.filter) || {};
