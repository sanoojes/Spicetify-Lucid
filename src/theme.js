...
`,document.head.appendChild(v)}t(),L(),k&&f(w,x),Spicetify.Player.addEventListener("songchange",()=>{!async function(){document.documentElement.style.setProperty("--fade-time","1s")}(),t(),k&&f(w,x)}),window.addEventListener("resize",L),console.log("Lucid theme loaded."),(async()=>{var e;await h("#customControls",5e3)&&(window.isCustomControls=!0,null!=(e=document.querySelector(".lucid-transperent-window-controls")))&&e.remove()})()};(async()=>{await V()})()})()}();