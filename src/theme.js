...
`,document.head.appendChild(g)}J(),W(),h&&v(f,w),Spicetify.Player.addEventListener("songchange",()=>{!async function(){document.documentElement.style.setProperty("--fade-time","1s")}(),J(),h&&v(f,w)}),window.addEventListener("resize",W),N(),console.log("Lucid theme loaded."),(async()=>{var e;await y("#customControls",5e3)&&(window.isCustomControls=!0,null!=(e=document.querySelector(".lucid-transperent-window-controls")))&&e.remove()})()};(async()=>{await K()})()})()}();