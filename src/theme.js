...
.spotify__container--is-desktop.spotify__os--is-windows .Root__globalNav {
  padding-inline: ${i}px ${a}px !important;
        ...
        `,"windows"===Spicetify.Platform.PlatformData.os_name&&"light"!==Spicetify.Config.color_scheme&&(e=m(135,t,1),i=64,a=e,S.classList.add("lucid-transperent-window-controls"),S.style.setProperty("--control-height",i+"px"),S.style.setProperty("--control-width",a+"px")))}async function y(t){let a=await h(".Root__top-container").catch(t=>console.error(t));function e(){var t=null==a?void 0:a.querySelector(".lucid-animated-background-container"),e=null==a?void 0:a.querySelector(".lucid-static-background-container");t&&t.remove(),e&&e.remove()}e();try{if("animated"===(t=t||"static")){var i,n=function(){var t=Math.floor(360*Math.random());document.documentElement.style.setProperty("--random-degree",t+"deg")},o=(n(),document.createElement("div")),l=(o.classList.add("lucid-animated-background-container"),["front","back","backleft","backright"]);for(i of l){var r=document.createElement("div");r.classList.add(i),o.appendChild(r)}null!=a&&a.prepend(o)}var s;"static"===t&&((s=document.createElement("div")).classList.add("lucid-static-background-container"),null!=a)&&a.prepend(s),"solid"===t&&e()}catch(t){console.error(t)}}document.head.appendChild(g);var b=document.createElement("style");function v(t){try{"stary"===(t=t||"stary")&&(b.innerText=`
      :root {
